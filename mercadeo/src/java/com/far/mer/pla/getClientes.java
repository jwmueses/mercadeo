...
public class getClientes extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try{
            ResultSet rs = objDB.consulta("select top(20) numero_idcliente, nombre_comercial from tbl_clientes with (nolock) where lower(nombre_comercial) like '%"+txt+"%'");
            msg = objDB.getError();
            ...
            while(rs.next()){
                ...
                html += "<option value=\"" + numero_idcliente+"\">" + nombre_comercial+"</option>";
            }
            rs.close();
        ...
        try {
            ...
            out.print("<select id=\"clie\" size=\"5\" onclick=\""+onClick+"\">"+html+"</select>");
        } finally {
            out.close();
        }
    }
