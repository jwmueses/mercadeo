 ...
 * @author Jorge
 */
public class getEstrategias extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            res = "obj»axEstrategias^frm»"+this.getEstrategias(objEstrategia, id_plan_mercadeo);
    ...
    public String getEstrategias(Estrategia objEstrategia, String id_plan_mercadeo)
    {
        ...
        try{
            ...
            html += "<tr><td colspan=\"3\" align=\"right\"><input type=\"hidden\" id=\"sum_estgs\" value=\""+sumatoria+"\" />"+sumatoria+"</th><th>&nbsp;</th></tr>";
            html += "</table>";
        }catch(Exception e){
            e.printStackTrace();
        }
