 ...
 * @author Jorge
 */
public class tblLiquidacionComprasFacturasGuardar extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(ok){
            ...
            //html = "obj»axGasto^frm»" + objActividad.tblFacturas(rsAct);
            //float total_gasto = objActividad.total_gasto();
            funciones = "^fun»mer_liquidacionAnadir("+id_plan_mercadeo+", "+id_actividad+");";
        }else{
