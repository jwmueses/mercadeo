 ...
 * @author Jorge
 */
public class setIdPlanCuenta extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String msg = "Ha ocurrido un error inesperado. Por favor, intentelo más tarde";
        ...
        if(objActividad.setIdPlanCuenta(id, id_plan_cuenta)){
